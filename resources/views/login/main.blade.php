    ...
    <div class="container sm:px-10">
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    <img class="-intro-x w-1/2 -mt-16" src="{{ asset('dist/images/auto.png') }}">
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">Bienvenue sur le tarificateur Auto <br></div>
                    <div class="-intro-x mt-5 text-lg text-white">Tarifez et générez vos attestations</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                ...
                <img src="{{ asset('dist/images/logo_cfao.jpg') }}">
                    <br>
                    ...
                    <div class="intro-x mt-8">
                        <form id="login-form">
                            ...
                            <input type="password" id="input-password" value="password" class="intro-x login__input input input--lg border border-gray-300 block mt-4" placeholder="Mot de passe">
                    ...
                    <div class="intro-x flex text-gray-700 text-xs sm:text-sm mt-4">
                        <div class="flex items-center mr-auto">
                            ...
                            <label class="cursor-pointer select-none" for="remember-me">Se souvenir</label>
                        </div>
                        <a href="">Mot de passe oublié ?</a>
                    </div>
                    <div class="intro-x mt-5 xl:mt-8 xl:flex justify-center xl:justify-start">
                        <button id="btn-login" class="button button--lg w-full xl:w-32 text-white bg-theme-1 xl:mr-3">Connexion</button>
                        <button class="button button--lg w-full xl:w-32 text-gray-700 border border-gray-300 mt-3 xl:mt-0">Inscription</button>
                    </div>
